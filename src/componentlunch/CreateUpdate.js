...
import '../trombiComponents/CreateOrUpdate.css';
    ...
    handleSubmit = (e) => {        
        ...
        .then((lunch)=>{
            ...
            let message = "Lunch with plat : " + lunch.plat +
                               ...
                               "\nperson :" + lunch.person.firstname + lunch.person.lastname +
                        ...
                        <form className="form" name ="formulaire" onSubmit={this.handleSubmit} >
                            ...
                            <div >Personne :  
                                {(admin  ? 
                                    ...
                                    </select> : newPerson.firstname + newPerson.lastname
                                )}
                            </div><br/>
                            <div>Image : <br/><img className="displayImg" src={lunch.image} alt="repas" /><br/>
                            <input className="" type="file" onChange={this.getImage} placeholder="Picture" accept="image/*" id="image"/></div>
